...
function autoSave() {
    ...
    const data = { player, inventory, gameState: { ...gameState, inBattle: false, enemy: null, battleLog: [], logs: gameState.logs, isProcessingTurn: false }, stats };
...
async function doPlayerMove(action, skillId) {
    ...
    let hitChance = (player.hitRate + 10) - enemyDodge; // 技能/普攻基礎修正
